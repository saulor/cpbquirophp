...
$sql .= "DATE_FORMAT(pacientes.data, '%d/%m/%Y %H:%i') as dataHoraFormatada, ";
$sql .= "pacientes.timestamp, ";
...
$sql .= "DATE_FORMAT(atendimentos.data, '%d/%m/%Y %H:%i') as dataHoraAtendimentoFormatada ";
$sql .= "from pacientes ";
