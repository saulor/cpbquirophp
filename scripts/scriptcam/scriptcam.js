...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			if (fileExists(decodeURIComponent(data.path)+'scripts/scriptcam/scriptcam.swf')) {
				swfobject.embedSWF(decodeURIComponent(data.path)+'scripts/scriptcam/scriptcam.swf', opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
